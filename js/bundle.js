...
},{"jquery":16,"raf":18}],20:[function(require,module,exports){
var $ = require('jquery');
var d3 = require('d3');
...
},{"d3":15,"jquery":16}],21:[function(require,module,exports){
/*var projectDataSet = [
	{src: 'img/dummy.jpg', description: 'Test text', program: ['Java'], url: 'http://github.com'},
	{src: 'img/dummy.jpg', description: 'Test text', program: ['Java'], url: 'http://github.com'},
	{src: 'img/dummy.jpg', description: 'Test text', program: ['VR'], url: 'http://github.com'},
	{src: 'img/dummy.jpg', description: 'Test text', program: ['C++'], url: 'http://github.com'},
	{src: 'img/dummy.jpg', description: 'Test text', program: ['C', 'C++'], url: 'http://github.com'},
	{src: 'img/dummy.jpg', description: 'Test text', program: ['JavaScript'], url: 'http://github.com'}
];
...
$(window).load(function() {
	for (var i = 0; i < projectDataSet.length; i++) {
		$projectList.append('<div class="proj"><img class="img img-responsive proj-img" src="'
			 + projectDataSet[i].src + '"/>' + '<div class="proj-descp">' 
			+  projectDataSet[i].description +'</div>' +'</div>');
	}

	for (var i = 0; i < filter) {
...
// $(window).scroll(function(){
//   $(".main-title").css({"top": ($(".main-title").position().top--) + "px"});
// });

var initTop = $('.fixedElement').offset().top;
...
require('bootstrap');
require('./loader.js');
require('./AnimateHeader.js');
require('./header.js');
require('./chart.js');
require('./filter.js');
require('./navigator.js');
require('./slideshow.js');
require('./smoothslider.js');

},{"./AnimateHeader.js":19,"./chart.js":20,"./filter.js":21,"./header.js":22,"./loader.js":23,"./navigator.js":25,"./slideshow.js":26,"./smoothslider.js":27,"bootstrap":2}],25:[function(require,module,exports){
var $ = require('jquery');
$(window).scroll(function() {
    var $el = $('.fixedElement');
...
},{"jquery":16,"raf":18}],27:[function(require,module,exports){
var $ = require('jquery');
